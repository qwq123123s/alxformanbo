...
public class ShuangshengBoots
extends ArmorItem {
    public ShuangshengBoots() {
        super(ShuangshengArmorMaterial.SHUANGSHENG, ArmorItem.Type.BOOTS, new Item.Properties().fireResistant().rarity(Rarity.EPIC));
    }
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag isAdvanced) {
        ...
        String text = Component.translatable((String)"tooltip.manbov2c.shuangsheng_boots").getString();
