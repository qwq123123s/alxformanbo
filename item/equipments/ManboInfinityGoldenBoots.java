...
public class ManboInfinityGoldenBoots
extends ArmorItem {
    public ManboInfinityGoldenBoots() {
    ...
    public void inventoryTick(ItemStack stack, Level level, Entity entity, int slot, boolean selected) {
        ...
        if (entity instanceof Player) {
            ...
            if (!stack.isEnchanted()) {
                ...
                stack.enchant(Enchantments.FALL_PROTECTION, 35);
            }
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag isAdvanced) {
        ...
        String text = Component.translatable((String)"tooltip.manbov2c.manbo_infinity_golden_boots").getString();
