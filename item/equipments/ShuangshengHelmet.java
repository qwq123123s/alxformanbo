...
public class ShuangshengHelmet
extends ArmorItem {
    private static final int NIGHT_VISION_DURATION = 1200;
    private static final int REFRESH_INTERVAL = 100;

    public ShuangshengHelmet() {
        super(ShuangshengArmorMaterial.SHUANGSHENG, ArmorItem.Type.HELMET, new Item.Properties().fireResistant().rarity(Rarity.EPIC));
    }
    ...
    public void inventoryTick(ItemStack stack, Level level, Entity entity, int slot, boolean selected) {
        ...
        if (entity instanceof Player) {
            ...
            if (player.getItemBySlot(EquipmentSlot.HEAD) == stack && ((current = player.getEffect(MobEffects.NIGHT_VISION)) == null || current.getDuration() < 1100)) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag isAdvanced) {
        ...
        String text = Component.translatable((String)"tooltip.manbov2c.shuangsheng_helmet").getString();
