...
public class NanbeilvdouChestplate
extends ArmorItem {
    public NanbeilvdouChestplate() {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag isAdvanced) {
        ...
        String text = Component.translatable((String)"tooltip.manbov2c.nanbeilvdou_chestplate").getString();
