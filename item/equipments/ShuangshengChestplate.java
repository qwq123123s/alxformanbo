...
public class ShuangshengChestplate
extends ArmorItem {
    public ShuangshengChestplate() {
        super(ShuangshengArmorMaterial.SHUANGSHENG, ArmorItem.Type.CHESTPLATE, new Item.Properties().fireResistant().rarity(Rarity.EPIC));
    }
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag isAdvanced) {
        ...
        String text = Component.translatable((String)"tooltip.manbov2c.shuangsheng_chestplate").getString();
