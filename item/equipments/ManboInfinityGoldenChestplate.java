...
public class ManboInfinityGoldenChestplate
extends ArmorItem {
    public ManboInfinityGoldenChestplate() {
    ...
    public void inventoryTick(ItemStack stack, Level level, Entity entity, int slot, boolean selected) {
        ...
        if (entity instanceof Player) {
            ...
            if (player.getItemBySlot(EquipmentSlot.CHEST) == stack) {
                ...
                player.addEffect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 100, 2, false, false, true));
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag isAdvanced) {
        ...
        String text = Component.translatable((String)"tooltip.manbov2c.manbo_infinity_golden_chestplate").getString();
