...
public class TianyuanChestplate
extends ArmorItem {
    public TianyuanChestplate() {
        super(TianyuanArmorMaterial.TIANYUAN, ArmorItem.Type.CHESTPLATE, new Item.Properties().fireResistant().rarity(Rarity.EPIC));
    }
    ...
    public void inventoryTick(ItemStack stack, Level level, Entity entity, int slot, boolean selected) {
        ...
        if (player.getItemBySlot(EquipmentSlot.CHEST) == stack) {
            player.addEffect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 100, 5, false, false, true));
            player.addEffect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 100, 5, false, false, true));
            player.addEffect(new MobEffectInstance(MobEffects.REGENERATION, 100, 4, false, false, true));
        }
    }

    public Component getName(ItemStack stack) {
        String baseName = Component.translatable((String)"item.manbov2c.tianyuan_chestplate").getString();
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag isAdvanced) {
        ...
        String text = Component.translatable((String)"tooltip.manbov2c.tianyuan_chestplate").getString();
