...
public class ManboInfinityUpgradeChestplate
extends ArmorItem {
    public ManboInfinityUpgradeChestplate() {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag isAdvanced) {
        ...
        String text = Component.translatable((String)"tooltip.manbov2c.manbo_infinity_upgrade_chestplate").getString();
