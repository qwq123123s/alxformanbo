...
public class TianyuanLeggings
extends ArmorItem {
    public TianyuanLeggings() {
        super(TianyuanArmorMaterial.TIANYUAN, ArmorItem.Type.LEGGINGS, new Item.Properties().fireResistant().rarity(Rarity.EPIC));
    }
    ...
    public Component getName(ItemStack stack) {
        String baseName = Component.translatable((String)"item.manbov2c.tianyuan_leggings").getString();
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag isAdvanced) {
        ...
        String text = Component.translatable((String)"tooltip.manbov2c.tianyuan_leggings").getString();
