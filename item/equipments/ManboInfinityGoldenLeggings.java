...
public class ManboInfinityGoldenLeggings
extends ArmorItem {
    public ManboInfinityGoldenLeggings() {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag isAdvanced) {
        ...
        String text = Component.translatable((String)"tooltip.manbov2c.manbo_infinity_golden_leggings").getString();
