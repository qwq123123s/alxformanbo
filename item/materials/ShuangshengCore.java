...
public class ShuangshengCore
extends Item {
    public ShuangshengCore() {
        super(new Item.Properties().rarity(Rarity.EPIC).fireResistant().stacksTo(64));
    }

    public Component getName(ItemStack stack) {
        String baseName = Component.translatable((String)"item.manbov2c.shuangsheng_core").getString();
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag isAdvanced) {
        ...
        String text = Component.translatable((String)"tooltip.manbov2c.shuangsheng_core").getString();
