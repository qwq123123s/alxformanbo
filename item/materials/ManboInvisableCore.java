...
import com.manbo.v2c.client.InvisableCoreOverlayHandler;
...
public class ManboInvisableCore
extends Item {
    private static final Random RANDOM = new Random();

    public ManboInvisableCore() {
        super(new Item.Properties().rarity(Rarity.EPIC).fireResistant().stacksTo(64));
    }

    public Component getName(ItemStack stack) {
        String baseName = Component.translatable((String)"item.manbov2c.manbo_invisable_core").getString();
        return ColorUtils.createRedPurpleGradientText(baseName);
    }

    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag isAdvanced) {
        super.appendHoverText(stack, level, tooltipComponents, isAdvanced);
        tooltipComponents.add((Component)this.createGarbledLine(InvisableCoreOverlayHandler.getGarbledPrefix()));
        String text = Component.translatable((String)"tooltip.manbov2c.manbo_invisable_core").getString();
        ...
        tooltipComponents.add((Component)this.createGarbledLine(InvisableCoreOverlayHandler.getGarbledSuffix()));
    }
