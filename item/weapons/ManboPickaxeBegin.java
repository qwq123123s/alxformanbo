...
public class ManboPickaxeBegin
        extends PickaxeItem {
    public ManboPickaxeBegin() {
    ...
    public Component getName(ItemStack stack) {
        String baseName = Component.translatable((String) "item.manbov2c.manbo_pickaxe_begin").getString();
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents,
        ...
        String text = Component.translatable((String) "tooltip.manbov2c.manbo_pickaxe_begin").getString();
        ...
        tooltipComponents
                .add((Component) ColorUtils.createRainbowText("\u65e0\u53cc \u6316\u6398\u901f\u5ea6", 0.8f, 0.04f));
        tooltipComponents
                .add((Component) ColorUtils.createRainbowText("\u65e0\u53cc \u6316\u6398\u6548\u7387", 0.8f, 0.04f));
    }
}
